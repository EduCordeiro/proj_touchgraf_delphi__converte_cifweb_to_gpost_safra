...
begin
  ...
  try
    ...
    begin
      ...
      objParametrosDeEntrada.CODIGO_AVALIACAO_TECNICA_BACEN             := objArquivoDeConfiguracao.getConfiguracao('CODIGO_AVALIACAO_TECNICA_BACEN');
      objParametrosDeEntrada.CODIGO_AVALIACAO_TECNICA_CCB               := objArquivoDeConfiguracao.getConfiguracao('CODIGO_AVALIACAO_TECNICA_CCB');
      ...
      objParametrosDeEntrada.PESO_BACEN                                 := objArquivoDeConfiguracao.getConfiguracao('PESO_BACEN');
      objParametrosDeEntrada.PESO_CCB                                   := objArquivoDeConfiguracao.getConfiguracao('PESO_CCB');
      objParametrosDeEntrada.PESO_CB7                                   := objArquivoDeConfiguracao.getConfiguracao('PESO_CB7');
...
//  ForceDirectories(sPathmovimentoCIF);
  ...
  begin
    ...
    Begin
      ...
      sNomeClienteEndereco              := objString.getTermo(03, ';', sLinha);
      sArquivoPdfOrigem                 := objString.getTermo(02, ';', sLinha);
      sTipoArquivoPdfOrigem             := AnsiUpperCase(Copy(sArquivoPdfOrigem, length(sArquivoPdfOrigem) - 5, 6));

      //============================================================================================================
      // DEFINIÇÃO INICIAL POR TIPO DE ARQUIVO
      //============================================================================================================
      ...
      if sTipoArquivoPdfOrigem = 'CC.PDF' then
      BEGIN
      ...
      //==================================================
      //  DEFINIÇÃO DO PESO PARA CADA PRODUTO
      //==================================================
      if sTipoArquivoOrigem_Bacen_CCB_CB7 = 'BACEN' then
        sPeso := objParametrosDeEntrada.PESO_BACEN;

      if sTipoArquivoOrigem_Bacen_CCB_CB7 = 'CCB' then
        sPeso := objParametrosDeEntrada.PESO_CCB;

      if sTipoArquivoOrigem_Bacen_CCB_CB7 = 'CB7' then
        sPeso := objParametrosDeEntrada.PESO_CB7;
      //==================================================

      sFolhas                           := '1';

      sCEP                              := objString.getTermo(07, ';', sLinha);
      ...
      sCIF_WEB                          := objString.getTermo(10, ';', sLinha);
      ...
      //====================================================================================
        ...
        sComando := 'insert into ' + objParametrosDeEntrada.TABELA_PROCESSAMENTO
                  ...
                  + '","' + sArquivoEntrada
                  + '","' + sTipoArquivoOrigem_Bacen_CCB_CB7
                  + '"'
                  + ')';
        objConexao.Executar_SQL(__queryMySQL_processamento__, sComando, 1);
